		...
		<plugins>
			...
			<plugin>
				...
				<configuration>
					...
					<suiteXmlFiles>
						<suitXmlFile>
							src/test/resources/testrunner/debug_chrome.xml
						</suitXmlFile>
					</suiteXmlFiles>
					...
					<!-- Ensure Lombok is the annotation processor actually used -->
					<annotationProcessorPaths>
						<path>
							<groupId>org.projectlombok</groupId>
							<artifactId>lombok</artifactId>
							<version>1.18.30</version> <!-- same as above -->
						</path>
					</annotationProcessorPaths>
